    ...
    <section className="relative isolate overflow-hidden border-t border-border/60 px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="relative isolate overflow-hidden rounded-4xl border border-primary/20 bg-background/15 shadow-[0_25px_80px_-35px_rgba(0,0,0,0.35)] backdrop-blur-md">
          ...
          <div className="pointer-events-none absolute -right-28 top-1/2 hidden aspect-square w-[55%] -translate-y-1/2 lg:block">
            ...
            <div className="absolute left-1/2 top-1/2 flex h-32 w-32 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border border-primary/25 bg-background/30 backdrop-blur-sm">
              ...
              <div className="flex h-20 w-20 flex-col items-center justify-center rounded-full border border-primary/20">
                ...
                <span className="mt-2 text-[9px] font-semibold uppercase tracking-widest text-surfac">
                  Your Home
                </span>
              </div>
          ...
          {/* Technical label */}
          <div className="absolute bottom-5 right-7 hidden items-center gap-2 text-[9px] font-semibold uppercase tracking-[0.18em] text-foreground lg:flex">
