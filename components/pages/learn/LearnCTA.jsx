        ...
        <div className="relative overflow-hidden rounded-4xl border border-white/35 bg-primary/10 px-6 py-16 text-center shadow-xl backdrop-blur-sm backdrop-saturate-120 sm:px-12 lg:py-20">
          ...
          <div className="relative">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-4">
              <Link
                href="/tools"
                className="inline-flex items-center justify-center rounded-full bg-primary-foreground hero-btn font-medium text-primary transition-all hover:bg-brand-cream"
              >
                Explore the tools
              </Link>
              <Link
